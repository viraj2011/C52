...
function setup() {
  ...
  playerBase = new PlayerBase( 200,420, 100, 100);
  player = new Player(300, playerBase.body.position.y - 150, 50, 180);
  ...
  computer = new Computer(
    width - 280,
    computerBase.body.position.y - 20,
    50,
    180
  );
  ...
  computerArcher = new ComputerArcher(
    width - 310,
    computerBase.body.position.y - 15,
    120,
    120
  );
...
function draw() {
  ...
  textAlign("center");
  textSize(40);
  text("ZOMBIE ARCHERY", width / 2, 100);
